        ...
        reImpl =
            AccessController.doPrivileged(new PrivilegedAction<RenderingEngine>() {
                public RenderingEngine run() {
                	...
                	final String piscesREClass = "javaawt.sun.java2d.pisces.PiscesRenderingEngine";
                    String reClass =
                        System.getProperty("sun.java2d.renderer", piscesREClass);
                    if (reClass.equals(piscesREClass)) {
                        try {
